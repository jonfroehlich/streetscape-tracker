...
def build():
    ...
    try:
        ...
        db.replace_driving_plan_entries(
            ...
            [
                (
                    earlier_id, "Testland", "TL", "SV", "Alphastate", "Alpha County", "Yes",
                    "2019-01-01T08:00:00.000Z", "2019-01-01",
                    "2019-06-01T07:00:00.000Z", "2019-06-01",
                ),
                (
                    earlier_id, "Testland", "TL", "SV", "Zerostate", "Zero County", "Yes",
                    "2026-03-01T08:00:00.000Z", "2026-03-01",
                    "2026-11-01T07:00:00.000Z", "2026-11-01",
                ),
                (
                    earlier_id, "Testland", "TL", "SV", "Mapstate", "Map County", "No",
                    "2019-01-01T08:00:00.000Z", "2019-01-01",
                    "2019-06-01T07:00:00.000Z", "2019-06-01",
                ),
                (
                    earlier_id, "Argentina", "AR", "SV", "Chubut", "Esquel", "Yes",
                    "2026-01-01T08:00:00.000Z", "2026-01-01",
                    "2026-12-31T08:00:00.000Z", "2026-12-31",
                ),
            ],
        )
        ...
        db.replace_driving_plan_entries(
            ...
            [
                ...
                (
                    snapshot_id, "Testland", "TL", "SV", "Alphastate", "Alpha County", "No",
                    "2019-01-01T08:00:00.000Z", "2019-01-01",
                    "2019-06-01T07:00:00.000Z", "2019-06-01",
                ),
                (
                    snapshot_id, "Testland", "TL", "SV", "Zerostate", "Zero County", "Yes",
                    "2026-03-01T08:00:00.000Z", "2026-03-01",
                    "2026-11-01T07:00:00.000Z", "2026-11-01",
                ),
                (
                    snapshot_id, "Testland", "TL", "SV", "Mapstate", "Map County", "No",
                    "2019-01-01T08:00:00.000Z", "2019-01-01",
                    "2019-06-01T07:00:00.000Z", "2019-06-01",
                ),
                (
                    snapshot_id, "Argentina", "AR", "SV", "Chubut", "Esquel", "Yes",
                    "2026-01-01T08:00:00.000Z", "2026-01-01",
                    "2026-12-31T08:00:00.000Z", "2026-12-31",
                ),
            ],
