...
Verified by mutation: deleting the affinity gate fails that test and `test_a_mapillary_block_at_knob_3_…` on every run; forcing one lane fails seven.
