...
The clock term is not optional: on prod 16/min over a 10 h batch paces ~9,600 requests against a 10,000 budget, so a cap set to a fresh night's remainder is unreachable by arithmetic and the arm actually taken stays the kill.
