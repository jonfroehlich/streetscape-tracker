...
What the cut *can* move is the daily count, by fitting more cities into a night; at ~20–40 queries against a ~100/day self-imposed reading of the guideline that is not close, but it is the number to re-check if the nightly slate ever grows substantially.
