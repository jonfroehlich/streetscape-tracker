...
| Nightly scheduler | Yes — every enabled city not excluded from the channel (#301) | Yes — same | Yes, but **opt-in**: only cities enrolled with `scheduler enroll-city` (#248) |
