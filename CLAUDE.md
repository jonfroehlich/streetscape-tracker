...
Two #334 lessons outlive its rule, both about tests: a layout gate is only as wide as its fixture (prod ran a provider ahead of it), and **"fits" is not "says anything"** — that gate stayed green the whole time a date group was missing, because a trimmed table fits by construction.
